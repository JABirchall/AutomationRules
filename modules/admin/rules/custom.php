...
class _custom extends \IPS\Node\Controller
{
    ...
    protected function manage()
    {
        ...
        if (!\IPS\Request::i()->isAjax()) {
            \IPS\Output::i(
            )->output .= '<div style="font-size:1.25em"><i class="fa fa-info"></i> Custom actions are used to create your own processing routines that can be scheduled or used as rules actions.</div>';
        }
