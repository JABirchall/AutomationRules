...
class _customlogs extends \IPS\Node\Controller
{
    ...
    protected function manage()
    {
        ...
        if (!\IPS\Request::i()->isAjax()) {
            \IPS\Output::i(
            )->output .= '<div style="font-size:1.25em"><i class="fa fa-info"></i> Custom logs are used to create your own activity streams for members, content, and nodes.</div>';
        }
    ...
    protected function flush()
    {
        ...
        \IPS\Output::i()->redirect(
            \IPS\Http\Url::internal("app=rules&module=rules&controller=customlogs"),
            'custom_log_flushed'
        );
    }
}
